...
public class privateChat extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		out.println("<li><a class='active scroll hvr-shutter-out-horizontal' href='privateChat'>private chat</a></li>");
...
out.println("<form  action='sendMs' method='get'>");
		...
		for (Entity result : pq.asIterable()) { 
			...
			out.println("<td >");
			out.print("<input type='checkbox' name='selected' value="+username+">");
			out.println("</td>");
			out.println("</tr>");
		 }
		out.println("</table>");
