...
public class publicChat extends HttpServlet {
...
String uname=ck[0].getValue();
		...
		out.println("<ul>");
		out.println("<li><a class='active scroll hvr-shutter-out-horizontal' href='publicChat'>public chat</a></li>");
...
//=========================================================================================================	
		...
		for (Entity result : pq.asIterable()) { 
			...
			String data=(String) result.getProperty("Date");
			//==============================================================
			...
			out.println("<td >");out.println(data);out.println("</td>");
			out.println("</tr>");
			//out.print("<br>");
		//out.println("</form>");
	}
        ...
        out.println("<form  action='/publicServlet' method='get'>");
		out.println("<TEXTAREA name='content' ROWS=2 COLS=60></TEXTAREA>");
		out.println(" </br>");
...
//==========================================================================================================		
		...
		//out.println("<TEXTAREA Name='content' ROWS=59 COLS=150>");
