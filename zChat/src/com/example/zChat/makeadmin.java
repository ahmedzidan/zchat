...
public class makeadmin extends HttpServlet {
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		out.println("<li><a class='active scroll hvr-shutter-out-horizontal' href='makeadmin'>Make Admin</a></li>");
...
//=========================================================================================================	
		...
		for (Entity result : pq.asIterable()) { 
			...
			out.println(username);out.println("</td>");
		...
		out.println("</table>");
		out.println(" <input type='submit' value='make admin!'>");
		out.println("</form>");
		out.println("</div>");
				out.println("</div>");
				out.println("</div>");
